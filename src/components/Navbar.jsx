...
export default function Navbar({ page, setPage }) {
  ...
  const activeStyle = {
    background: 'rgba(190,91,67,0.18)',
    color: '#FE9150',
    border: '1px solid rgba(254,145,80,0.4)',
    boxShadow: '0 0 14px rgba(190,91,67,0.25)',
  };
  const inactiveStyle = {
  ...
  return (
    <>
      ...
      <nav className="hidden lg:block sticky top-0 z-40"
        style={{ background: 'rgba(11,5,7,0.97)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', borderBottom: '1px solid var(--border2)', position: 'relative' }}>
      ...
      <div className="lg:hidden sticky top-0 z-40 flex items-center justify-between px-4 md:px-6"
        style={{ background: 'rgba(11,5,7,0.97)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', borderBottom: '1px solid var(--border2)', height: 'clamp(48px, 8vh, 64px)' }}>
      ...
      {showLogin && (
        <div className="overlay flex items-center justify-center p-4">
          <div className="fade-up w-full max-w-sm"
            style={{ background: 'var(--surface)', border: '1px solid var(--border3)', borderRadius: '20px', boxShadow: '0 0 60px rgba(190,91,67,0.15), 0 32px 64px rgba(0,0,0,0.6)' }}>
            ...
            <div className="p-6">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-11 h-11 rounded-xl flex items-center justify-center shrink-0"
                  style={{ background: 'rgba(190,91,67,0.15)', border: '1px solid var(--border3)' }}>

  ...
  return (
    <div className="overlay fade-in" style={{ background: 'rgba(15,18,24,0.96)' }}>
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ background: '#252c33', borderBottom: '1px solid var(--border2)', padding: '12px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '10px', position: 'sticky', top: 0, zIndex: 10 }}>
        ...
        <div style={{ background: '#2e3740', borderBottom: '1px solid var(--border)', padding: '10px 16px', display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
        ...
        <div style={{ flex: 1, background: '#fff' }}>
          ...
          {/* Song header */}
          <div style={{ background: 'linear-gradient(135deg, #252c33, #2e3740)', padding: '20px 20px', borderBottom: '3px solid var(--accent)', position: 'relative', overflow: 'hidden' }}>
          ...
          {/* Sheet footer */}
          <div style={{ background: 'linear-gradient(135deg, #252c33, #2e3740)', padding: '14px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderTop: '1px solid var(--border)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
